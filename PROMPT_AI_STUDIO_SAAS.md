# PROMPT — ALTEC SaaS (colar no Google AI Studio)

---

## CONTEXTO DO PROJETO

Você é um engenheiro sênior fullstack. Você vai transformar o **ALTEC** — um sistema de gestão de estoque e logística industrial (GLP/gás) — em um **SaaS completo**, pronto para vender no Brasil.
...
Landing page completa, dark por padrão, identidade visual TECGAS/ALTEC.
Seções (em ordem):

**Hero:**
- Logo ALTEC + tagline: "Gestão industrial de estoque e logística. Simples, rápido, no controle."
...
*Projeto: ALTEC — Sistema de Gestão Industrial de Estoque e Logística*  
*Empresa: TECGAS GLP Solutions*  
*Repositório: github.com/esdrasgomes547-maker/ALTEC*
